...
class GestureTracker(BaseVisualModality):
    ...
    def __init__(self, name: str = "gesture_tracker", source: int = 0, 
                 width: int = 640, height: int = 480,
                 min_detection_confidence: float = 0.7, 
                 min_tracking_confidence: float = 0.7,
                 model_path: str = 'Modality/models/gesture_recognition/model_output/gesture_model.h5',
                 feature_mean_path: str = 'Modality/models/gesture_recognition/model_data/feature_mean.npy',
                 feature_scale_path: str = 'Modality/models/gesture_recognition/model_data/feature_scale.npy',
