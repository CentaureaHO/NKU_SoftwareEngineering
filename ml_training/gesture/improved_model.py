...
def train_model(data_file, model_dir='model_output', epochs=100, batch_size=64):
    """训练改进的手势识别模型
    
    Args:
        data_file: 数据文件路径
        model_dir: 模型输出目录，用于存储训练好的模型和评估结果
        epochs: 训练轮数
        batch_size: 批次大小
    """
...
if __name__ == "__main__":
    # 训练模型
    data_path = 'Modality/models/gesture_recognition/model_data/hand_features.npz'
    model_output_path = 'Modality/models/gesture_recognition/model_output'
    train_model(data_path, model_dir=model_output_path) 